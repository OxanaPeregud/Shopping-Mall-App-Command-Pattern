...
class DeleteListDiscountsCommandTest extends MockInit {
    ...
    void execute() throws ServletException, IOException {
        ...
        assertEquals(idList, request.getParameterValues(PARAM_DELETE_DISCOUNT));

        new DeleteListDiscountsCommand().execute(request, response);
